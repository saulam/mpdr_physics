...
name="mpds-s-z256-best"
log_every_n_steps=10
save_top_k=1
pretrained_ae="/raid/monsals/mpdr_physics/checkpoints/ae-aug-z256-50e/last-v2.ckpt"
init_net_x_ae="/raid/monsals/mpdr_physics/checkpoints/ae-aug-z256-50e/last-v2.ckpt"
checkpoint_path="/raid/monsals/mpdr_physics/checkpoints"
checkpoint_name="mpdr-s-z256-best_real"
gpus=(3)

python -m train.mpdr-s_optuna \
    --latent_token \
    --pos_embedding \
    --augment \
